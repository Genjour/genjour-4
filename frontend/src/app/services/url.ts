...
export class url {
    public static  getArticles           = "/articles";
    public static article                = "/journal/";
    public static JournalsByCategory     = "/journals/";
    public static quotationContent       = "/quotations/";
    public static journalFeeds           = "/journals/feeds/";
    public static search                 = "/search";
    public static register               = "/register";
    public static authenticate           = "/authenticate";
    public static postQuotation          = "/journal/add/quotation";
    public static postArticle            = "/journal/add/article";
    public static saveArticle            = "/journal/add/article";
    public static profile                = "/profile";
    public static genjouristProfile      = "/genjourist/";
    public static articles               = "/genjourist/article/";
    public static quotation              = "/genjourist/quotation/";
    public static getSupportingList      = "/supportingList/";
    public static getSupportersList      = "/supportersList/"
    public static getDraftJournal        = "/edit/journal/";
    public static getDraftQuotation      = "/edit/quotation/";
    public static deleteJournal          = "/delete/journal/"
    public static updateJournal          = "/update/journal/";
    public static recommendedUser        = "/recommended/users/";
    public static changeProfileImage     = "/genjourist/profileImage/";
    public static getJournal             = "/journal";
    public static getJournalById         = "/journal/";
    public static profileJournals        = "/genjourist/journals/";
    public static profileArticles        = "/genjourist/article/";
    public static profileQuotation       = "/genjourist/quotation/";
    public static getQuotations          = "/quotations";
    public static supportJournal         = "/support/journal/";
    public static journalSupporters      = "/journal/supportersList/";
    public static supportGenjourist      = "/support/genjourist/";
    public static checkSupportStatus     = "/checkSupportStatus/";
    public static findUserAndUpdateInfo  = "/update/userInfo/";
    public static addComment             = "/add/comment";
    public static getComments            = "/comments/";
    public static getReplies             = "/replies/";
    public static addReply               = "/add/reply";
    public static deleteComment          = "/delete/comment/";
    public static deleteReply            = "/delete/reply/";
