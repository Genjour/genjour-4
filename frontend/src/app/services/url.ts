...
export class url {
   ...
   public static article = "http://localhost:3000/journal/";
    ...
    public static getSupportersList = "http://localhost:3000/supporteresList/"
    public static getDraftArticles = "http://localhost:3000/edit/article/";
    public static getDraftQuotation = "http://localhost:3000/edit/quotation/";
    public static deleteArticle = "http://localhost:3000/delete/article/"
    public static draftArticles = "http://localhost:3000/update/article/";
    public static updateArticle = "http://localhost:3000/update/article/";
    ...
    public static supportingGenjourist = "http://localhost:3000/supporting/genjourist/";
